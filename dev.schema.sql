...
CREATE TABLE `blog_review_logs` (
  ...
  CONSTRAINT `blog_review_logs_ibfk_1` FOREIGN KEY (`place_id`) REFERENCES `places` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `daily_ranking_logs` (
  ...
  CONSTRAINT `daily_ranking_logs_ibfk_1` FOREIGN KEY (`keyword_id`) REFERENCES `keywords` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `daily_ranking_logs_ibfk_2` FOREIGN KEY (`place_id`) REFERENCES `places` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `agree_marketing_term` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-03-03 18:34:35
