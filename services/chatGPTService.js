...
2) 결과 키워드에서 브랜드명, 업체명은 제외해 주세요.
3) 근처 랜드마크, 명소에 관한 언급을 놓치지 않고 파악해 주세요.
4) 가장 많이 검색될 것 같은 키워드 30개를 추출해 주세요.
5) 단, 키워드의 조합은 항상 위치키워드(랜드마크, 명소, 건물, 지역, 주소 등) + 업체특징키워드(맛집, 헬스장, PT, 술집, 고기집, 횟집, 메뉴명, 헤어샵, 서비스명 등) 로 구성되어있어야 합니다. 위치키워드만 또는 업체특징키워드만으로 구성된 키워드는 제외해 주세요.
